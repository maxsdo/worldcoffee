...
Ready to deploy your Mini App? See the comprehensive [Deployment Guide](./DEPLOYMENT.md) for step-by-step instructions on deploying to Vercel.

Quick Deploy to Vercel:
- Push your code to GitHub
- Import project at https://vercel.com/new
- Configure environment variables (AUTH_SECRET, HMAC_SECRET_KEY, AUTH_URL, NEXT_PUBLIC_APP_ID)
- Deploy!
